...
* The original package name 'com.in2minutes.microservices.cloud.spring-cloud-config' is invalid and this project uses 'com.in2minutes.microservices.cloud.springcloudconfig' instead.
